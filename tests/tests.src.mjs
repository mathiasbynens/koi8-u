...
assert.deepStrictEqual(
	koi8u.decode(new Uint16Array([0xFFFF]), { mode: 'replacement' }),
	'\uFFFD',
...
assert.throws(
	() => {
		koi8u.decode(new Uint16Array([0xFFFF]), { mode: 'fatal' });
	},
	Error,
